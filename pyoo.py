...
class SpreadsheetDocument(_UnoProxy):
    ...
    def calculate_all(self):
        """
        Calculate all formulas in document
        :return:
        """
        self._target.calculateAll()

    def save(self, path=None, filter_name=None, filter_data=None):
        """
        ...
        if filter_name:
            ...
            if filter_data:
                format_filter_data = uno.createUnoStruct('com.sun.star.beans.PropertyValue')
                format_filter_data.Name = 'FilterData'
                options = []
                ...
                format_filter_data.Value = uno.Any("[]com.sun.star.beans.PropertyValue", tuple(options))
                filters = (format_filter, format_filter_data)
        else:
            filters = ()
